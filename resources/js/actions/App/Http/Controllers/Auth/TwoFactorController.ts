...
/**
* @see \App\Http\Controllers\Auth\TwoFactorController::showChallenge
 * @see app/Http/Controllers/Auth/TwoFactorController.php:15
 * @route '/twoFactorChallenge'
 */
export const showChallenge = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: showChallenge.url(options),
    method: 'get',
})

showChallenge.definition = {
    methods: ["get","head"],
 ...
 * @route '/twoFactorChallenge'
 */
showChallenge.url = (options?: RouteQueryOptions) => {
    return showChallenge.definition.url + queryParams(options)
}
 ...
 * @route '/twoFactorChallenge'
 */
showChallenge.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: showChallenge.url(options),
    method: 'get',
})
/**
 ...
 * @route '/twoFactorChallenge'
 */
showChallenge.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: showChallenge.url(options),
    method: 'head',
})
 ...
 * @route '/twoFactorChallenge'
 */
    const showChallengeForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: showChallenge.url(options),
        method: 'get',
    })
 ...
 * @route '/twoFactorChallenge'
 */
        showChallengeForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: showChallenge.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/twoFactorChallenge'
 */
        showChallengeForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: showChallenge.url({
    ...
    showChallenge.form = showChallengeForm
/**
...
const TwoFactorController = { showChallenge, confirm, disable, enable }
